...
export default class VizualizationsGraph extends React.Component {
  ...
  render() {
    ...
    let breadCrumbsArr = [];
    let iframe = '<iframe style="border: none;" src="'+domain+':8200/graph/index.html" width="'+this.state.iframeWidth+'" height="'+this.state.iframeHeight+'"></iframe>';
    contentTitle = "Graph vizualization";
    contentHTML = <div>
